...
public class ViewHotels extends JFrame implements Runnable{
    ...
    public void run(){
        String text[] = new String[]{"JW Marriott Hotel","Mandarin Oriental Hotel","Four Seasons Hotel","Raddisson Blue Hotel","Classsio Hotel","The Bay Club Hotel","Breeze Blow Hotel","The Emperial Hotel","Happy Morning Motel","The Royal Touch Hotel"};
