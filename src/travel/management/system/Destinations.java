...
public class Destinations extends JFrame implements Runnable{
    ...
    public void run(){
        String text[] = new String[]{"Andaman & Nicobar","Goa","Kashmir","Kerala","Leh Ladakh","Manali","Pondicherry","Shimla","Sikkim","Udaipur"};
    ...
    Destinations(){
        ...
        caption = new JLabel();
        caption.setBounds(50,20,1000,70);
        caption.setFont(new Font("Tahoma",Font.BOLD,30));
        caption.setForeground(new Color(255, 0, 0));
        add(caption);
